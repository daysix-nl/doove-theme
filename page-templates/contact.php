...
<!-- HEADER 2 -->
    <section class="h-[127px] md:h-[130px] lg:h-[140px] xl:h-[160px] mt-[82px] md:mt-[71px] lg:mt-[68px] bg-[#F4F4F5]">
        <div class="container h-full flex flex-col justify-center">
            ...
            <h1 class="text-22 leading-33 md:text-25 md:leading-35 lg:text-31 lg:leading-41 xl:text-35 xl:leading-45 font-satoshi text-[#ED701F] font-semibold pt-1">Contact</h1>
        </div>
    </section>
...
<section>
        <div class="container grid grid-cols-1 lg:grid-cols-2 items-start pt-5 pb-[35px] md:pt-4 md:pb-4 lg:pt-[85px] lg:pb-[85px] xl:pt-9 xl:pb-9">
            <div class="col-span-1 grid gap-[25px] md:gap-3 lg:gap-4">
                <h2 class="text-25 leading-35 md:text-21 md:leading-28 xl:text-25 xl:leading-33 font-satoshi text-[#ED701F] font-semibold lg:max-w-[439px] xl:max-w-[527px]">Stuur ons een bericht</h2>
                <p class="text-16 leading-25 md:text-14 md:leading-24 lg:text-15 lg:leading-25 xl:text-16 xl:leading-25 font-nunito text-black font-normal max-w-[350px] md:max-w-[382px] lg:max-w-[410px] xl:max-w-[437px]">Stuur ons een mail als wij u ergens mee kunnen helpen of als u vragen of suggesties heeft.</p>   
    ...
    <div class="container lg:flex xl:space-x-[180px] lg:space-x-[168px] space-x-0 space-y-4 lg:space-y-0">
        <div class="xl:max-w-[316px] lg:max-w-[310px] md:max-w-[412px] lg:ml-4 xl:ml-[47px]">
            ...
            <div>
                ...
                <p class="font-bold text-[#000000] font-nunito xl:text-15 xl:leading-25  lg:text-15 lg:leading-25 md:text-14 md:leading-24 text-16 leading-25 xl:pb-1.5 lg:pb-1 md:pb-1.5 pb-[15px]">Wilhelminakade 10, 2741 JV Waddinxveen</p>
                <p class="text-[#332E2A] xl:text-15 font-nunito xl:leading-25  lg:text-15 lg:leading-25 md:text-14 md:leading-24 text-16 leading-25 lg:max-w-[273px] md:max-w-full max-w-[273px]">Op werkdagen zijn wij bereikbaar van 08.30 tot 17.00 uur.</p>
            </div>
            <div class="xl:pt-4 lg:pt-2.5 md:pt-3 pt-4">
                ...
                <p class="font-bold text-[#000000] font-nunito xl:text-15 xl:leading-25  lg:text-15 lg:leading-25 md:text-14 md:leading-24 text-16 leading-25 xl:pb-1.5 lg:pb-1 md:pb-1.5 pb-[15px]">Kouwe Hoek 4, 2741 PX Waddinxveen</p>
                <p  class="text-[#332E2A] xl:text-15 font-nunito xl:leading-25  lg:text-15 lg:leading-25 md:text-14 md:leading-24 text-16 leading-25 lg:max-w-[300px] md:max-w-full max-w-[300px]">De werkplaats is op werkdagen geopend van 09.00 tot 16.00 uur.</p>
            </div>
        </div>
        ...
        <div class="">
            ...
            <div class="xl:space-y-3 lg:space-y-2 md:space-y-2 space-y-2">
                <div class="flex flex-col lg:flex-row w-full">
                    ...
                    <p class="text-[#000000] font-nunito font-normal xl:text-16 xl:leading-25 lg:text-15 lg:leading-25 md:text-14 md:leading-24 text-16 leading-25">0182 624 900 / info@doove.nl</p>
                </div>
                <div class="flex flex-col lg:flex-row">
                    ...
                    <p class="text-[#000000] font-nunito font-normal xl:text-16 xl:leading-25 lg:text-15 lg:leading-25 md:text-14 md:leading-24 text-16 leading-25">0182 624 999 / sales@doove.nl</p>
                </div>
                <div class="flex flex-col lg:flex-row">
                    ...
                    <p class="text-[#000000] font-nunito font-normal xl:text-16 xl:leading-25 lg:text-15 lg:leading-25 md:text-14 md:leading-24 text-16 leading-25">0182 624 930 / verhuur@doove.nl</p>
                </div>
                <div class="flex flex-col lg:flex-row">
                    ...
                    <p class="text-[#000000] font-nunito font-normal xl:text-16 xl:leading-25 lg:text-15 lg:leading-25 md:text-14 md:leading-24 text-16 leading-25">0182 624 970 / verzekerdezorg@doove.nl</p>
                </div>
                <div class="flex flex-col lg:flex-row">
                    ...
                    <p class="text-[#000000] font-nunito font-normal xl:text-16 xl:leading-25 lg:text-15 lg:leading-25 md:text-14 md:leading-24 text-16 leading-25">0182 624 990 / service@doove.nl</p>
                </div>
                <div class="flex flex-col lg:flex-row">
                    ...
                    <p class="text-[#000000] font-nunito font-normal xl:text-16 xl:leading-25 lg:text-15 lg:leading-25 md:text-14 md:leading-24 text-16 leading-25">0182 624 9995 / planning@doove.nl</p>
                </div>
            </div>
        </div>
...
<!-- overige gegevens -->
<section class="xl:pb-[55px] xl:pt-[45px] lg:pb-[53] lg:pt-[60px] md:pt-[35px] md:pb-[43px] pt-6 pb-4 lg:ml-4 xl:ml-[47px]">
    <div  class="container">
        ...
        <div class="max-w-[750px] grid grid-cols-1 lg:grid-cols-2 text-16 leading-25 md:text-14 md:leading-24 lg:text-15 lg:leading-25  font-nunito text-[#332E2A] font-normal content">
            <div class="grid xl:grid-cols-[185px_185px] lg:grid-cols-[185px_195px] md:grid-cols-[170px_160px] grid-cols-[163px_183px]">
                ...
                <p class="font-nunito text-[#000000] xl:text-16 xl:leading-25 lg:text-15 lg:leading-25 md:text-14 md:leading-25 text-16 leading-25">29035244</p>   
                ...
                <p class="font-nunito text-[#000000] xl:text-16 xl:leading-25 lg:text-15 lg:leading-25 md:text-14 md:leading-25 text-16 leading-25">NL801419219B04</p>    
            </div>
            <div class="grid xl:grid-cols-[185px_185px] lg:grid-cols-[185px_195px] md:grid-cols-[170px_160px] grid-cols-[163px_183px]">
                ...
                <p class="font-nunito text-[#000000] xl:text-16 xl:leading-25 lg:text-15 lg:leading-25 md:text-14 md:leading-25 text-16 leading-25 uppercase">NL83INGB0695112554</p>   
                ...
                <p class="uppercase font-nunito text-[#000000] xl:text-16 xl:leading-25 lg:text-15 lg:leading-25 md:text-14 md:leading-25 text-16 leading-25">INGBNL2A</p>  
            </div>
        </div>
    </div>
</section>
