   ...
   <!-- MEER VIDEO'S -->
    <section class="bg-<?php the_field('achtergrond_kleur');?> <?php the_field('padding_top');?> <?php the_field('padding_bottom');?>">
        ...
        <div class="container relative mySwiper">
            ...
            <div class="swiper-button-next top-[92px] md:top-[65px] lg:top-[102px] xl:top-[117px] left-[0px] md:left-[-40px]"></div>
            <div class="swiper-button-prev top-[92px] md:top-[65px] lg:top-[102px] xl:top-[117px] right-[0px] md:right-[-40px]"></div>
        </div>
