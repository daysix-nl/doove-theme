                            ...
                            $related_query->the_post(); ?>
                              ...
                              <a href="<?php the_permalink();?>" class="col-span-1 md:last-of-type:hidden lg:last-of-type:block">
                                    <div class="w-full aspect-square bg-[#F4F4F4] flex items-center justify-center">
                                        <img class="w-auto h-auto max-w-[133px] max-h-[133px] md:max-w-[170px] md:max-h-[170px] lg:max-w-[215px] lg:max-h-[215px] xl:max-w-[242px] xl:max-h-[242px]" src="<?php the_post_thumbnail_url();?>" alt="<?php the_title();?>">
                                    </div>
