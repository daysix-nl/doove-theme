                        ...
                        while ( have_rows('uitgelichte_items_repeater') ) : the_row();
                                ...
                                <div class="col-span-1 px-[unset] md:px-2 lg:px-[27px] xl:px-3 pt-[unset] lg:pt-4 xl:pt-5 pb-[unset] lg:pb-3 xl:pb-3 grid rounded-xl relative uspcard">
                                    <div class="grid gap-2 md:gap-3 lg:gap-[35px] xl:gap-3 content-between">
                                        <div class="grid gap-[35px] md:gap-[25px] lg:gap-3">
                                            <h3 class="text-25 leading-30 md:text-21 md:leading-28 lg:text-22 lg:leading-25 xl:text-25 xl:leading-30 font-satoshi text-black font-semibold titel lg:min-h-[50px]"><?php the_sub_field('item_1_titel');?></h3>
                            ...
                            elseif( get_row_layout() == 'item_2' ):  ?>
                                ...
                                <div class="col-span-1 px-[unset] md:px-2 lg:px-[27px] xl:px-3 pt-[unset] lg:pt-4 xl:pt-5 pb-[unset] lg:pb-3 xl:pb-3 grid rounded-xl relative uspcard">
                                    <div class="grid gap-2 md:gap-3 lg:gap-[35px] xl:gap-3 content-between">
                                        <div class="grid gap-[35px] md:gap-[25px] lg:gap-3">
                                            <h3 class="text-25 leading-30 md:text-21 md:leading-28 lg:text-22 lg:leading-25 xl:text-25 xl:leading-30 font-satoshi text-[#4EBE5B] font-semibold titel green lg:min-h-[50px]"><?php the_sub_field('item_2_titel');?></h3>
                            ...
                            elseif( get_row_layout() == 'item_3' ):  ?>
                                ...
                                <a href="<?php the_sub_field('item_3_link');?>" class="col-span-1 px-[unset] md:px-2 lg:px-[27px] xl:px-3 pt-[unset] lg:pt-4 xl:pt-5 pb-[unset] lg:pb-3 xl:pb-3 grid lg:hover:bg-white duration-300 rounded-xl relative uspcard">
                                    <div class="grid gap-2 md:gap-3 lg:gap-[35px] xl:gap-3 content-between">
                                        <div class="grid gap-[35px] md:gap-[25px] lg:gap-3">
                                            <h3 class="text-25 leading-30 md:text-21 md:leading-28 lg:text-22 lg:leading-25 xl:text-25 xl:leading-30 font-satoshi text-black font-semibold titel lg:min-h-[50px]"><?php the_sub_field('item_3_titel');?></h3>
                            ...
                            elseif( get_row_layout() == 'item_4' ):  ?>
                                 <!-- ITEM MET LINK - GROEN -->
                                    <a href="<?php the_sub_field('item_4_link');?>" class="col-span-1 px-[unset] md:px-2 lg:px-[27px] xl:px-3 pt-[unset] lg:pt-4 xl:pt-5 pb-[unset] lg:pb-3 xl:pb-3 grid lg:hover:bg-white duration-300 rounded-xl relative uspcard">
                                        <div class="grid gap-2 md:gap-3 lg:gap-[35px] xl:gap-3 content-between">
                                            <div class="grid gap-[35px] md:gap-[25px] lg:gap-3">
                                                <h3 class="text-25 leading-30 md:text-21 md:leading-28 lg:text-22 lg:leading-25 xl:text-25 xl:leading-30 font-satoshi text-[#4EBE5B] font-semibold green lg:min-h-[50px]"><?php the_sub_field('item_4_titel');?></h3>
