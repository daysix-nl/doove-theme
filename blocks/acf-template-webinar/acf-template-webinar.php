    ...
    <section class="xl:pb-[93px] lg:pb-[81px] md:pb-[54px] pb-5" >
        <div class="container">
            <div class="w-full xl:max-w-[893px] lg:max-w-[747]">
                ...
                <p class="text-[#332E2A]/[0.5] font-nunito font-normal xl:text-18 xl:leading-30 lg:text-15 lg:leading-25 md:text-14 md:leading-24 text-15 leading-30 xl:pb-3 lg:pb-[27px] md:pb-[22px] pb-2.5 capitalize"><?php echo $formatted_date; ?></p>
