   ...
   <!-- HEADER 2 -->
    <section class="h-[127px] md:h-[130px] lg:h-[140px] xl:h-[160px] mt-[82px] md:mt-[71px] lg:mt-[68px] bg-[#F4F4F5]">
        <div class="container h-full flex flex-col justify-center">
            ...
            <h1 class="text-22 leading-33 md:text-25 md:leading-35 lg:text-31 lg:leading-41 xl:text-35 xl:leading-45 font-satoshi text-[#ED701F] font-semibold pt-1"> <?php single_term_title(); // Toont de naam van de categorie. ?></h1>
        </div>
    </section>
                        ...
                        while ($query->have_posts()) {
                            ...
                            <a href="<?php the_permalink();?>" class="col-span-1">
                                <div class="w-full aspect-square bg-[#F4F4F4] flex items-center justify-center">
                                    <img class="w-auto h-auto max-w-[133px] max-h-[133px] md:max-w-[170px] md:max-h-[170px] lg:max-w-[215px] lg:max-h-[215px] xl:max-w-[242px] xl:max-h-[242px]" src="/wp-content/themes/doove-theme/img/local/image129.png" alt="">
                                </div>
